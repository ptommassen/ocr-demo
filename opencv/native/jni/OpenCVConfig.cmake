...
#      - OpenCV_VERSION                  : The version of this OpenCV build: "2.4.6"
...
set(OpenCV_LIB_DIR_OPT "${OpenCV_INSTALL_PATH}/sdk/native/libs/${ANDROID_NDK_ABI_NAME}" CACHE PATH "Path where release OpenCV libraries are located")
set(OpenCV_LIB_DIR_DBG "${OpenCV_INSTALL_PATH}/sdk/native/libs/${ANDROID_NDK_ABI_NAME}" CACHE PATH "Path where debug OpenCV libraries are located")
set(OpenCV_3RDPARTY_LIB_DIR_OPT "${OpenCV_INSTALL_PATH}/sdk/native/3rdparty/libs/${ANDROID_NDK_ABI_NAME}" CACHE PATH "Path where release 3rdpaty OpenCV dependencies are located")
set(OpenCV_3RDPARTY_LIB_DIR_DBG "${OpenCV_INSTALL_PATH}/sdk/native/3rdparty/libs/${ANDROID_NDK_ABI_NAME}" CACHE PATH "Path where debug 3rdpaty OpenCV dependencies are located")
...
SET(OpenCV_LIB_COMPONENTS opencv_core;opencv_imgproc;opencv_flann;opencv_androidcamera;opencv_highgui;opencv_features2d;opencv_video;opencv_photo;opencv_calib3d;opencv_videostab;opencv_ts;opencv_objdetect;opencv_stitching;opencv_ml;opencv_legacy;opencv_contrib;opencv_java)
...
set(OpenCV_opencv_java_LIBNAME_OPT "libopencv_java.so")
...
set(OpenCV_opencv_java_LIBNAME_DBG "libopencv_java.so")
